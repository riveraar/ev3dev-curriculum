...
Much like we did in riveraar of the motors unit, later we will show you different (better) ways to use buttons.

Authors: David Fisher and Bryce Nesius.
...
def main():
    ...
    while True:
        ...
        if btn.backspace:
            break
        time.sleep(.01)  # Best practice to have a short delay to avoid working too hard between loop iterations.
