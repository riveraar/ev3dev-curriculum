...
def main():
    ...
    root.bind('<Up>', lambda event: turn_left(mqtt_client, right_speed_entry))
    ...
    root.bind('<Up>', lambda event: turn_right(mqtt_client, left_speed_entry))
    ...
    root.bind('<Up>', lambda event: drive_backward(mqtt_client,
                                                   left_speed_entry, right_speed_entry))
...
def turn_left(mqtt_client, right_speed_entry):
    print('left')
    mqtt_client.send_message('left', [int(right_speed_entry.get())])
